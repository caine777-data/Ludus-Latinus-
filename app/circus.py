...
QUESTIONS_CIRCUS = [
    ...
    {"q": "Comment appelle-t-on un char tiré par 4 chevaux ?", "rep": "Quadriga", "fausses": ["Biga", "Triga", "Seiuga"]},
    {"q": "Que désignent les 'frena' tenues par l'aurige ?", "rep": "Les rênes / le mors", "fausses": ["Le fouet", "La toge", "Le casque"]},
    {"q": "Que signifie 'flagellum' ?", "rep": "Le fouet", "fausses": ["L'épée", "Le bouclier", "La lance"]},
    {"q": "Que signifie 'currus' ?", "rep": "Le char de course", "fausses": ["La route", "La maison", "Le bateau"]},
    {"q": "Que sont les 'metae' aux extrémités de la piste ?", "rep": "Les bornes du virage", "fausses": ["Les portes", "Les gradins", "Les stalles"]},
    ...
    {"q": "Quels objets géants servaient aussi de compte-tours ?", "rep": "Les œufs (ova)", "fausses": ["Des boucliers", "Des couronnes", "Des glaives"]},
    {"q": "Que sont les 'carceres' au départ de la course ?", "rep": "Les stalles de départ", "fausses": ["Les prisons", "Les gradins", "Les écuries royales"]},
    {"q": "Quel linge blanc lâchait-on pour donner le départ ?", "rep": "La mappa", "fausses": ["La stola", "La fascia", "La bulla"]},
    {"q": "Quelle loge impériale reliait le palais au cirque ?", "rep": "Le Pulvinar", "fausses": ["Le Forum", "La Curia", "Le Tabularium"]},
    ...
    {"q": "Quelle faction porte la couleur verte au cirque ?", "rep": "Prasini", "fausses": ["Veneti", "Russati", "Albati"]},
    {"q": "Quelle faction porte la couleur blanche au cirque ?", "rep": "Albati", "fausses": ["Veneti", "Russati", "Prasini"]},
    ...
    {"q": "Que signifie l'ordre de l'aurige : 'Frena' ?", "rep": "Freine ! / Retiens !", "fausses": ["Accélère !", "Fouette !", "Descends !"]},
    {"q": "Que crie le public enthousiaste : 'Vince' ?", "rep": "Vaincs ! / Gagne !", "fausses": ["Fuis !", "Dors !", "Chante !"]},
    {"q": "Que signifie 'lente' dans 'Festina lente' ?", "rep": "Lentement", "fausses": ["Vite", "Fortement", "Secrètement"]},
    {"q": "Que signifie l'adverbe 'fortiter' ?", "rep": "Courageusement", "fausses": ["Faiblement", "En tremblant", "Doucement"]},
    {"q": "Que signifie 'audacter' ?", "rep": "Avec audace", "fausses": ["Avec peur", "En cachette", "Sans bruit"]},
    {"q": "Que signifie 'statim' sur la piste ?", "rep": "Immédiatement", "fausses": ["Demain", "Peut-être", "Plus tard"]},
    {"q": "Que signifie 'supera' crié au cocher ?", "rep": "Dépasse ! / Surpasse !", "fausses": ["Abandonne !", "Tombe !", "Recule !"]},
    {"q": "Que signifie le cri de mise en garde : 'Cave' ?", "rep": "Prends garde !", "fausses": ["Regarde le ciel", "Ferme les yeux", "Tout va bien"]},
    {"q": "Comment dit-on 'quatre' en latin (quadrige) ?", "rep": "Quattuor", "fausses": ["Tres", "Quinque", "Duo"]},
    {"q": "Combien de tours comportait une course classique ?", "rep": "7 tours", "fausses": ["3 tours", "10 tours", "12 tours"]},
    {"q": "Comment appelle-t-on un char à deux chevaux ?", "rep": "Biga", "fausses": ["Quadriga", "Triga", "Plaustrum"]},
    {"q": "Comment dit-on 'un' en latin ?", "rep": "Unus", "fausses": ["Tres", "Duo", "Mille"]},
    {"q": "Comment dit-on 'dix' en latin ?", "rep": "Decem", "fausses": ["Centum", "Quinque", "Octo"]},
    {"q": "Que signifie 'primus' pour le char en tête ?", "rep": "Le premier", "fausses": ["Le dernier", "Le deuxième", "L'inconnu"]},
    {"q": "Que signifie 'victoria' à l'arrivée ?", "rep": "La victoire", "fausses": ["La défaite", "Le départ", "La route"]},
    {"q": "Quel végétal symbolique recevait le vainqueur ?", "rep": "La palme (palma)", "fausses": ["Une rose", "Un épi de blé", "Un cep de vigne"]},
    {"q": "Que portait l'aurige victorieux sur sa tête ?", "rep": "Une couronne de lauriers", "fausses": ["Un diadème d'or", "Un casque en fer", "Un voile de soie"]},
    {"q": "Quel dieu patron des chevaux protégeait les auriges ?", "rep": "Neptune", "fausses": ["Vulcain", "Bacchus", "Pluton"]},
    {"q": "Quel dieu de la guerre inspirait la vaillance ?", "rep": "Mars", "fausses": ["Mercure", "Apollon", "Jupiter"]},
    {"q": "Quel oiseau sacré représentait la puissance de Rome ?", "rep": "L'aigle (aquila)", "fausses": ["La colombe", "Le corbeau", "Le paon"]},
    {"q": "Quel animal légendaire a nourri Romulus et Rémus ?", "rep": "La louve (lupa)", "fausses": ["La biche", "L'ourse", "La lionne"]},
    {"q": "À quel dieu solaire la course était-elle dédiée ?", "rep": "Sol (Le Soleil)", "fausses": ["Luna", "Saturne", "Cérès"]},
    {"q": "Que signifie 'triumphus' ?", "rep": "Le triomphe", "fausses": ["Le deuil", "L'exil", "Le traité"]},
    {"q": "Que signifie 'populus' dans SPQR ?", "rep": "Le peuple", "fausses": ["L'armée", "La noblesse", "La ville"]},
    {"q": "Que signifie 'gloria' célébrée par la foule ?", "rep": "La gloire", "fausses": ["La peur", "La nuit", "Le sommeil"]},
    {"q": "Que signifie 'imperator' ?", "rep": "Le chef victorieux", "fausses": ["L'esclave", "Le marchand", "L'artisan"]},
]

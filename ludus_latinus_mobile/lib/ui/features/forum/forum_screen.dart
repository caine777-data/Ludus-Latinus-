...
/// Écran de reconstruction impériale du Forum Romanum.
class ForumScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return AnimatedBuilder(
      ...
      builder: (context, _) {
        ...
        return Scaffold(
          appBar: AppBar(
            title: const Text('🏛️ FORUM IMPERIALE'),
            actions: [
              Container(
          ...
          body: ListView(
            ...
            children: [
              // Bannière d'introduction au Forum
              Container(
                padding: const EdgeInsets.all(16),
                decoration: BoxDecoration(
                  gradient: const LinearGradient(
                    colors: [RomanColors.imperialPurple, Color(0xFF4A101D)],
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const Text(
                      'Restaurez les chefs-d’œuvre de la Ville Éternelle grâce à vos sesterces de quête. Chaque monument débloque des bonus permanents pour votre aventure !',
                      style: TextStyle(
                          ...
                          SnackBar(
                            ...
                            content: Row(
                              children: [
                                ...
                                Expanded(
                                  child: Text(
                                    ' a été restauré avec gloire ! Bonus actif : ',
  ...
  Widget _buildMonumentCard({
    ...
    Color borderColor = isRestored ? RomanColors.laurelGreen : RomanColors.imperialGold;
    Color bgColor = isRestored ? const Color(0xFFF6FBF7) : RomanColors.travertinWhite;
      ...
      child: Column(
        ...
        children: [
          Row(
            ...
            children: [
              Container(
                ...
                height: 44,
                decoration: BoxDecoration(
                  color: isRestored ? RomanColors.laurelGreen.withOpacity(0.15) : RomanColors.goldLight,
          ...
          Container(
            ...
            decoration: BoxDecoration(
              color: isRestored ? const Color(0xFFE8F5E9) : const Color(0xFFFFFBEA),
          ...
          if (!isRestored) ...[
            ...
            Align(
              ...
              child: ElevatedButton.icon(
                ...
                label: Text(canAfford ? 'Reconstruire ce monument' : 'Fonds insuffisants'),
